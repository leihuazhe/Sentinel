 ...
 */
@Controller
@RequestMapping(value = "/v2/system", produces = MediaType.APPLICATION_JSON_VALUE)
public class SystemControllerV2 {
    ...
    Result<List<SystemRuleEntity>> queryMachineRules(HttpServletRequest request, String app) {
    ...
    Result<?> add(HttpServletRequest request,
        ...
        try{
            ...
            return Result.ofFail(-1, "fetch fail.please retry");
        }

        if (notNullCount != 1 || rules.size() >0) {

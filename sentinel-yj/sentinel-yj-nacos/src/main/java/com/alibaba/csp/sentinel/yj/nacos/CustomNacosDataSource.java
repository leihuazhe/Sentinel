...
public class CustomNacosDataSource<T> extends AbstractDataSource<String, T> {
    ...
    /**
     *
     * @param configService properties for construct {@link ConfigService} using {@link NacosFactory#createConfigService(Properties)}
     * @param groupId    group ID, cannot be empty
     * @param dataId     data ID, cannot be empty
     * @param parser     customized data parser, cannot be empty
     */
    public CustomNacosDataSource(final ConfigService configService, final Properties properties,final String groupId, final String dataId,
        ...
        AssertUtil.notNull(configService, "Nacos properties must not be null, you could put some keys from PropertyKeyConst");
        ...
        this.configListener = new Listener() {
            ...
            public void receiveConfigInfo(final String configInfo) {
                ...
                T newValue = com.alibaba.csp.sentinel.yj.nacos.CustomNacosDataSource.this.parser.convert(configInfo);
